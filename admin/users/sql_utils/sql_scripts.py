...
User={
    ...
    "List":"SELECT USERS.ID id, USERS.USERNAME username, USERS.FIRSTNAME firstName, USERS.LASTNAME lastName, ROLE.NAME role, CRM.NAME FROM USERS JOIN ROLE ON USERS.ROLE_ID = ROLE.ID JOIN CRM ON USERS.CRM_ID = CRM.ID",
